sudo ip tunnel add 6to4tunir018001 mode sit remote 164.92.246.10 local 85.133.194.228
...
sudo ip tunnel add 6to4tunir018004 mode sit remote 174.138.5.192 local 85.133.194.228
