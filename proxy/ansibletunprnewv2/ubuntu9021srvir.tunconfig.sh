sudo ip tunnel add 6to4tunir021001 mode sit remote 157.90.71.217 ansible_user=root ansible_port=22 local 185.26.32.175 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir021002 mode sit remote 148.251.119.123 ansible_user=root ansible_port=22 local 185.26.32.175 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir021003 mode sit remote 136.243.26.216 ansible_user=root ansible_port=22 local 185.26.32.175 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir021004 mode sit remote 185.223.235.100 ansible_user=root ansible_port=22 local 185.26.32.175 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir021005 mode sit remote 136.243.26.215 ansible_user=root ansible_port=22 local 185.26.32.175 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir021006 mode sit remote 152.42.137.215 ansible_user=root ansible_port=22 local 185.26.32.175 ansible_user=root ansible_port=22
