sudo ip tunnel add 6to4tundg004001 mode sit remote 31.216.62.115 local 159.203.98.51
...
sudo ip tunnel add 6to4tundg004002 mode sit remote 159.223.28.71 local 159.203.98.51
