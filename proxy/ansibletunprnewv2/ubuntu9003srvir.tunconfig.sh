sudo ip tunnel add 6to4tunir003001 mode sit remote 157.90.71.217 ansible_user=root ansible_port=22 local 94.182.223.249 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir003002 mode sit remote 148.251.119.123 ansible_user=root ansible_port=22 local 94.182.223.249 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir003003 mode sit remote 136.243.26.216 ansible_user=root ansible_port=22 local 94.182.223.249 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir003004 mode sit remote 185.223.235.100 ansible_user=root ansible_port=22 local 94.182.223.249 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir003005 mode sit remote 136.243.26.215 ansible_user=root ansible_port=22 local 94.182.223.249 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir003006 mode sit remote 152.42.137.215 ansible_user=root ansible_port=22 local 94.182.223.249 ansible_user=root ansible_port=22
