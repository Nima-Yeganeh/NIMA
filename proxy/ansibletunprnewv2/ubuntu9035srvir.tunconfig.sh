...
sudo ip tunnel add 6to4tunir035004 mode sit remote 185.223.235.100 local 185.26.32.252
...
sudo ip tunnel add 6to4tunir035008 mode sit remote 206.189.24.175 local 185.26.32.252
