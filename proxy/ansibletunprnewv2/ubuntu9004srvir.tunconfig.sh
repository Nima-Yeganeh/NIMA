sudo ip tunnel add 6to4tunir004001 mode sit remote 157.90.71.217 local 94.182.150.22
...
sudo ip tunnel add 6to4tunir004002 mode sit remote 148.251.119.123 local 94.182.150.22
...
sudo ip tunnel add 6to4tunir004003 mode sit remote 136.243.26.216 local 94.182.150.22
...
sudo ip tunnel add 6to4tunir004004 mode sit remote 209.38.36.161 local 94.182.150.22
...
sudo ip tunnel add 6to4tunir004005 mode sit remote 136.243.26.215 local 94.182.150.22
...
sudo ip tunnel add 6to4tunir004006 mode sit remote 152.42.137.215 local 94.182.150.22
...
sudo ip tunnel add 6to4tunir004007 mode sit remote 139.59.167.164 local 94.182.150.22
sudo ip -6 addr add fc00:4:7::253/64 dev 6to4tunir004007
sudo ip link set 6to4tunir004007 mtu 1400
sudo ip link set 6to4tunir004007 up
sudo ip -6 tunnel add gre6tunir004007 mode ip6gre remote fc00:4:7::254 local fc00:4:7::253
sudo ip addr add 10.4.7.253/30 dev gre6tunir004007
sudo ip link set gre6tunir004007 mtu 1300
sudo ip link set gre6tunir004007 up
sudo ip tunnel add 6to4tunir004008 mode sit remote 206.189.24.175 local 94.182.150.22
sudo ip -6 addr add fc00:4:8::253/64 dev 6to4tunir004008
sudo ip link set 6to4tunir004008 mtu 1400
sudo ip link set 6to4tunir004008 up
sudo ip -6 tunnel add gre6tunir004008 mode ip6gre remote fc00:4:8::254 local fc00:4:8::253
sudo ip addr add 10.4.8.253/30 dev gre6tunir004008
sudo ip link set gre6tunir004008 mtu 1300
sudo ip link set gre6tunir004008 up
sudo ip tunnel add 6to4tunir004009 mode sit remote 142.93.238.98 local 94.182.150.22
sudo ip -6 addr add fc00:4:9::253/64 dev 6to4tunir004009
sudo ip link set 6to4tunir004009 mtu 1400
sudo ip link set 6to4tunir004009 up
sudo ip -6 tunnel add gre6tunir004009 mode ip6gre remote fc00:4:9::254 local fc00:4:9::253
sudo ip addr add 10.4.9.253/30 dev gre6tunir004009
sudo ip link set gre6tunir004009 mtu 1300
sudo ip link set gre6tunir004009 up
