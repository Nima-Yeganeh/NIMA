...
sudo ip tunnel add 6to4tunir010004 mode sit remote 185.223.235.100 local 94.182.134.195
...
sudo ip tunnel add 6to4tunir010005 mode sit remote 165.232.76.77 local 94.182.134.195
