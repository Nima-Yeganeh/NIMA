sudo ip tunnel add 6to4tunir007001 mode sit remote 157.90.71.217 ansible_user=root ansible_port=22 local 31.216.62.162 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir007002 mode sit remote 148.251.119.123 ansible_user=root ansible_port=22 local 31.216.62.162 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir007003 mode sit remote 136.243.26.216 ansible_user=root ansible_port=22 local 31.216.62.162 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir007004 mode sit remote 185.223.235.100 ansible_user=root ansible_port=22 local 31.216.62.162 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir007005 mode sit remote 136.243.26.215 ansible_user=root ansible_port=22 local 31.216.62.162 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir007006 mode sit remote 152.42.137.215 ansible_user=root ansible_port=22 local 31.216.62.162 ansible_user=root ansible_port=22
