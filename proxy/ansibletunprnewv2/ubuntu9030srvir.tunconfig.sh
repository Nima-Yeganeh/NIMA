sudo ip tunnel add 6to4tunir030001 mode sit remote 157.90.71.217 ansible_user=root ansible_port=22 local 193.111.234.211 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir030002 mode sit remote 148.251.119.123 ansible_user=root ansible_port=22 local 193.111.234.211 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir030003 mode sit remote 136.243.26.216 ansible_user=root ansible_port=22 local 193.111.234.211 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir030004 mode sit remote 185.223.235.100 ansible_user=root ansible_port=22 local 193.111.234.211 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir030005 mode sit remote 136.243.26.215 ansible_user=root ansible_port=22 local 193.111.234.211 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir030006 mode sit remote 152.42.137.215 ansible_user=root ansible_port=22 local 193.111.234.211 ansible_user=root ansible_port=22
