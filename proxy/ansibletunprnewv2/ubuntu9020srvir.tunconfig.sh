sudo ip tunnel add 6to4tunir020001 mode sit remote 157.90.71.217 ansible_user=root ansible_port=22 local 185.26.32.137 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir020002 mode sit remote 148.251.119.123 ansible_user=root ansible_port=22 local 185.26.32.137 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir020003 mode sit remote 136.243.26.216 ansible_user=root ansible_port=22 local 185.26.32.137 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir020004 mode sit remote 185.223.235.100 ansible_user=root ansible_port=22 local 185.26.32.137 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir020005 mode sit remote 136.243.26.215 ansible_user=root ansible_port=22 local 185.26.32.137 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir020006 mode sit remote 152.42.137.215 ansible_user=root ansible_port=22 local 185.26.32.137 ansible_user=root ansible_port=22
