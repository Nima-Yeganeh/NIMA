sudo ip tunnel add 6to4tunir020001 mode sit remote 164.92.246.10 local 185.26.32.137
...
sudo ip tunnel add 6to4tunir020004 mode sit remote 174.138.5.192 local 185.26.32.137
