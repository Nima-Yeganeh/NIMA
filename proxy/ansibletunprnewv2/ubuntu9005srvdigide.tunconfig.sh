...
sudo ip tunnel add 6to4tundg005030 mode sit remote 193.111.234.211 local 165.232.76.77
...
sudo ip tunnel add 6to4tundg005031 mode sit remote 193.134.100.62 local 165.232.76.77
