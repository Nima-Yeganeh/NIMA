...
sudo ip tunnel add 6to4tunir015003 mode sit remote 136.243.26.216 local 94.182.138.86
...
sudo ip tunnel add 6to4tunir015004 mode sit remote 209.38.36.161 local 94.182.138.86
...
sudo ip tunnel add 6to4tunir015005 mode sit remote 136.243.26.215 local 94.182.138.86
...
sudo ip tunnel add 6to4tunir015006 mode sit remote 152.42.137.215 local 94.182.138.86
...
sudo ip tunnel add 6to4tunir015007 mode sit remote 139.59.167.164 local 94.182.138.86
sudo ip -6 addr add fc00:15:7::253/64 dev 6to4tunir015007
sudo ip link set 6to4tunir015007 mtu 1400
sudo ip link set 6to4tunir015007 up
sudo ip -6 tunnel add gre6tunir015007 mode ip6gre remote fc00:15:7::254 local fc00:15:7::253
sudo ip addr add 10.15.7.253/30 dev gre6tunir015007
sudo ip link set gre6tunir015007 mtu 1300
sudo ip link set gre6tunir015007 up
sudo ip tunnel add 6to4tunir015008 mode sit remote 206.189.24.175 local 94.182.138.86
sudo ip -6 addr add fc00:15:8::253/64 dev 6to4tunir015008
sudo ip link set 6to4tunir015008 mtu 1400
sudo ip link set 6to4tunir015008 up
sudo ip -6 tunnel add gre6tunir015008 mode ip6gre remote fc00:15:8::254 local fc00:15:8::253
sudo ip addr add 10.15.8.253/30 dev gre6tunir015008
sudo ip link set gre6tunir015008 mtu 1300
sudo ip link set gre6tunir015008 up
sudo ip tunnel add 6to4tunir015009 mode sit remote 142.93.238.98 local 94.182.138.86
sudo ip -6 addr add fc00:15:9::253/64 dev 6to4tunir015009
sudo ip link set 6to4tunir015009 mtu 1400
sudo ip link set 6to4tunir015009 up
sudo ip -6 tunnel add gre6tunir015009 mode ip6gre remote fc00:15:9::254 local fc00:15:9::253
sudo ip addr add 10.15.9.253/30 dev gre6tunir015009
sudo ip link set gre6tunir015009 mtu 1300
sudo ip link set gre6tunir015009 up
