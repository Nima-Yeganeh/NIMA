sudo ip tunnel add 6to4tunir017001 mode sit remote 164.92.246.10 local 94.182.138.88
...
sudo ip tunnel add 6to4tunir017004 mode sit remote 174.138.5.192 local 94.182.138.88
