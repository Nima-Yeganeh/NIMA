sudo ip tunnel add 6to4tunir014001 mode sit remote 157.90.71.217 ansible_user=root ansible_port=22 local 193.111.234.118 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir014002 mode sit remote 148.251.119.123 ansible_user=root ansible_port=22 local 193.111.234.118 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir014003 mode sit remote 136.243.26.216 ansible_user=root ansible_port=22 local 193.111.234.118 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir014004 mode sit remote 185.223.235.100 ansible_user=root ansible_port=22 local 193.111.234.118 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir014005 mode sit remote 136.243.26.215 ansible_user=root ansible_port=22 local 193.111.234.118 ansible_user=root ansible_port=22
...
sudo ip tunnel add 6to4tunir014006 mode sit remote 109.61.42.82 ansible_user=ubuntu ansible_port=22 local 193.111.234.118 ansible_user=root ansible_port=22
